...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[12rem] overflow-hidden rounded-md border border-line-strong bg-popover p-1 text-popover-foreground shadow-md",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("px-2 py-1.5 font-mono text-[10px] uppercase tracking-[0.09em] text-dim", className)}
    {...props}
  />
))
